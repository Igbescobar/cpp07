...
/*   Updated: 2026/02/03 15:31:28 by igngonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	{
		std::cout << "numbers[" << i << "] = " << numbers[i] << " (0 by default)" << std::endl;
	}
	...
	copyNumbers[0] = 999;
	std::cout << "Original numbers[0]: " << numbers[0] << " (unchanged)" << std::endl;
	...
	assigned = numbers;
	assigned[1] = 888;
	std::cout << "Original numbers[1]: " << numbers[1] << " (unchanged)" << std::endl;
